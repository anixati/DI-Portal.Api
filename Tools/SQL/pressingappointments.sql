...
WHERE 
((a.EndDate >= @DateReport and a.EndDate <= DateAdd(month,6,@DateReport) or r.MinisterOfficeDate >= @DateReport and r.MinisterOfficeDate <= DateAdd(month,6,@DateReport)) or (a.StartDate is null  ))
